...
import { checkMultiUserPermissionInOrg } from '../checkMultiUserPermissionsInOrg.js';
...
export default function main(data) {
  ...
  const response = checkMultiUserPermissionInOrg(data.orgID, data.userPool[user].id);
